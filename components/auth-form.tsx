      ...
      <dialog aria-labelledby="service-guide-title" className="access-guide-dialog" ref={dialogRef}>
        <section className="access-guide-modal">
          ...
          <div className="access-guide-content">
            ...
            <section className="guide-test-section"><span>TEST</span><h3>테스트는 이 순서로 진행하세요</h3><dl><div><dt>회사명</dt><dd>아이엠</dd></div><div><dt>비밀번호</dt><dd>a123456789</dd></div></dl><div className="guide-downloads"><a download href="/test-data/CarbonReply-test-data.zip">정상 12개월 ZIP 다운로드 <b>↓</b></a><a download href="/test-data/CarbonReply-test-exceptions.zip">예외 자료 ZIP 다운로드 <b>↓</b></a></div><ol><li><b>정상 흐름</b><p>정상 12개월 ZIP 하나를 업로드해 2026년 프로젝트를 만들고 결과 리포트까지 진행합니다.</p></li><li><b>예외 흐름</b><p>새 프로젝트에서 예외 자료 ZIP을 올려 중복·연도 불일치·고지서 아님 경고와 다음 행동이 이해되는지 확인합니다.</p></li><li><b>피드백</b><p>처음 해야 할 일, 원본 대조의 의미, 경고 뒤 다음 행동이 명확했는지 알려주세요.</p></li></ol></section>
