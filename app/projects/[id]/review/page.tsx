...
export default async function ReviewPage({ params }: ReviewPageProps) {
  ...
  return <main className="review-page"><section className="review-panel">
    ...
    <footer className="review-next">{canCreateReport ? <><span>모든 사용량을 확정했습니다. 최종 계산 결과를 확인할 수 있습니다.</span><a href={`/projects/${project.id}/report`}>결과 리포트 보기</a></> : <><span>모든 월의 사용량을 확정하면 결과 리포트를 만들 수 있습니다.</span><button disabled type="button">결과 리포트 보기</button></>}</footer>
  </section></main>;
}
