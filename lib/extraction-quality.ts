export type ParseErrorCode = "invalid_pdf" | "not_electricity_bill" | "year_mismatch" | "invalid_usage" | "duplicate_month" | "extraction_failed" | null;
...
export function getExtractionQuality(document: ExtractionDocument): ExtractionQuality {
  ...
  const messages: Record<Exclude<ParseErrorCode, null>, string> = {
    ...
    not_electricity_bill: "전기요금 고지서가 아닌 문서이거나, 고지서의 사용량(kWh)을 확인할 수 없습니다.",
